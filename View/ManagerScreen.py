...
class ManagerScr(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.logout_bt = tk.Button(self, text='Log Out', width=20, height=2, command = lambda : self.controller.show_frame("LogIn"))
        ...
        self.diemdanh_bt = tk.Button(self, text='List Event', width=20, height=2, command = lambda : self.controller.show_frame("ListEventScreen"))
